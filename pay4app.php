...
* 
* 	HOW TO INSTALL THE PAY4APP THINGS
*	1. Go to your database management and find the table 'payment' processors
*	2. Note the processor_id of the last row in that table
* 	3. Add a new row to the database. CSCart say 3rd party gateways must
* 		have their IDs starting at 1000 and upward. Enter a processor_id
* 		of 1000 or greater (one tha's not taken)
* 	4. Enter 'Pay4App' (without qotes) in the 'processor' field
* 	5. 'pay4app.php' (without quotes) in processor_script
* 	6. 'views/orders/components/payments/cc_outside.tpl' in 'processor
* 		template' (without the quotes)
* 	7. 'pay4app.tpl' in the admin_template field
* 	8. callback must be 'N' and type 'P' (both without the quotes)
* 	9. Browse to your cscart installation folder. Add the pay4app.php
* 		file to the folder path app/payments/pay4app.php
* 	10. Also add the pay4app.tpl file to path:
* 		design/backend/templates/views/payments/components/cc_processors/pay4app.tpl
*	11. In your CSCart admin, go to the 'Administration'->'Payments' menu
*		and pick Pay4App from the list. Enter your merchant details as they
*		are provided you in your Pay4App Merchant dashboard on Pay4App
*
****************************************************************************/
